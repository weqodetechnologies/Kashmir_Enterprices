...
export default function Infrastructure() {
  return (
    <section className="w-full bg-white py-12 px-4 sm:px-10 lg:px-28">
      {/* HEADER */}
      <div className="max-w-6xl mx-auto mb-8">
        <h2 className="text-3xl sm:text-4xl lg:text-[64px] font-black text-[#545353] mb-3  ">
          INFRASTRUCTURE
        </h2>
        <p className="text-gray-600 max-w-6xl text-sm sm:text-base md:text-lg lg:text-2xl  ">
          Infrastructure builds strong communities by improving transport,
          utilities, and public services for sustainable growth.
        </p>
      </div>
