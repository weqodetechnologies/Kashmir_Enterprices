...
export default function Testimonials() {
  ...
  return (
    <section className="w-full px-4 sm:px-4 md:px-6 lg:px-8  py-6 sm:py-6 md:py-8 lg:py-8 space-y-4 ">
      {/* Heading */}
      <h1 className=" px-4 sm:px-8 md:px-12 lg:px-20 text-left text-[36px] sm:text-[36px] md:text-[60px] lg:text-[80px] font-black text-[#545353] tracking-[6px] leading-none">
        TESTIMONIALS
      </h1>
