...
export default function Projects() {
  ...
  return (
    <section className="w-full px-4 sm:px-8 md:px-12 lg:px-28 py-16 space-y-8">
      ...
      {/* SUBTEXT */}
      <p className="max-w-4xl text-[#3E3E3E] text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed font-medium ">
      ...
      <div className="relative w-full">
        ...
        <div
          ref={scrollRef}
          className="flex gap-8 overflow-x-scroll scroll-smooth no-scrollbar pb-4"
        >
          {/* CARD 1 */}
          <div className="min-w-[330px] sm:min-w-[400px] md:min-w-[460px] bg-white rounded-[28px] overflow-hidden shadow-md">
            {/* IMAGE */}
            <img
              src={project1}
            ...
            <div className="bg-black text-white p-6 rounded-b-[28px] space-y-4">
              ...
              <p className="text-md leading-relaxed text-gray-300 font-regular  ">
          ...
          <div className="min-w-[330px] sm:min-w-[400px] md:min-w-[460px] bg-white rounded-[28px] overflow-hidden shadow-md">
            ...
            {/* CONTENT */}
            <div className="bg-black text-white p-6 rounded-b-[28px] space-y-4">
              <h2 className="text-2xl font-semibold">Iron Ore Mining</h2>
          ...
          <div className="min-w-[330px] sm:min-w-[400px] md:min-w-[460px] bg-white rounded-[28px] overflow-hidden shadow-md">
            ...
            {/* CONTENT */}
            <div className="bg-black text-white p-6 rounded-b-[28px] space-y-4">
              <h2 className="text-2xl font-semibold">Roadside Plantation</h2>
